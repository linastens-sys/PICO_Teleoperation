  ...
  try:
    ...
    while True:
      ...
      if len(left_hand_state) > 0:
        ...
        print(
          f"Left Wrist Position: ({left_wrist_pos[0]:.3f}, {left_wrist_pos[1]:.3f}, {left_wrist_pos[2]:.3f})"
        )

      if len(right_hand_state) > 0:
        right_wrist_pos = right_hand_state[0][:3]  # x, y, z
        print(
          f"Right Wrist Position: ({right_wrist_pos[0]:.3f}, {right_wrist_pos[1]:.3f}, {right_wrist_pos[2]:.3f})"
        )
